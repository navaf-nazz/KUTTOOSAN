...
Asena.addCommand({pattern: 'menu', fromMe: false, desc: Lang.WP}, (async (message, match) => {
    ...
    r_text[0] = "https://github.com/navaf-nazz/KUTTOOSAN/raw/master/KUTTOOSAN-407x400.png";
    ...
    await message.sendMessage(Buffer(respoimage.data), MessageType.image, {mimetype: Mimetype.png, caption: `⛦━━━━━🔰 *NAVAF* 🔰━━━━━⛦


𝐇𝐞𝐥𝐥𝐨👋 𝐈 𝐚𝐦 𝐚 NAVAF 𝐛𝐨𝐭.
       *KUTTOOSAN*
