...
Asena.addCommand({pattern: 'menu', fromMe: false, desc: Lang.WP}, (async (message, match) => {
    ...
    r_text[0] = "https://github.com/DEVILSER/DEVILSER/raw/main/Media/Ammu/Ammukutty-407x400.png";
    ...
    await message.sendMessage(Buffer(respoimage.data), MessageType.image, {mimetype: Mimetype.png, caption: `⛦━━━━━✨️DEVILSER✨️━━━━━⛦


𝐇𝐞𝐥𝐥𝐨👋 𝐈 𝐚𝐦 DEVILSER'S 𝐛𝐨𝐭.
   🔱 *AMMUKUTTY* 🔱
